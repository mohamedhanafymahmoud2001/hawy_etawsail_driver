                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style:
                                                AppTextStyles.style32W400(context)
                                                    .copyWith(
                                                        color: AppColors.white,
                                                        fontFamily: "Lemonada"),
                                          ),
                      ...
                      MaterialButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(             "${langLocal.langLocal['withdraw_request']!['${val.languagebox.get("language")}']}",
                                style:
                                    AppTextStyles.style14W400(context).copyWith(
                                  color: AppColors.white,
                                )),
                            SizedBox(
                              width: 8,
                      ...
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            return ItemWallet(
                              type: val.walet['data']['withdraws'][i]
                                          ['status'] ==
                                      "pending"
                                  ? " طلب سحب "
                                  : val.walet['data']['withdraws'][i]
                                              ['status'] ==
                                          "rejected"
                                      ? " رفض السحب"
                                      : " تم السحب ",
                              ...
                              color: val.walet['data']['withdraws'][i]
                                          ['status'] ==
                                      "pending"
